...
exports.setRequestUrl=function(app){
    ...
    app.get('/', user.login);
    //app.all(/\/(article|user|index)\/\*/, user.authenticate)

    //user
    app.post('/onLogin', user.onLogin);
    app.get('/user/userList', user.userList);
    app.get('/user/addUser', user.addUser);
    app.get('/user/userManager/:type', user.userManager);
    app.post('/user/userManager_up/:type', user.userManager_up);
    ...
    app.get("/article/articleDelete/:articleId",articleObj.delete);
};
