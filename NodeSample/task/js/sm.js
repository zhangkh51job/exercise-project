 ...
 * =====================================================
 */
;$.smVersion = "0.5.3";/* global Zepto:true */
+function ($) {
    "use strict";
...
;(function () {
    ...
    FastClick.prototype.findControl = function(labelElement) {
        ...
        // All browsers under other that support touch events also support the HTML5 htmlFor attribute
    ...
    var Calendar = function (params) {
        ...
        p.updateValue = function () {
            ...
            for (i = 0; i < p.value.length; i++) {
                ...
                p.wrapper.find('.picker-calendar-day[data-date="' + valueDate.getFullYear() + '-' + formatNumber(valueDate.getMonth()+1) + '-' + formatNumber(valueDate.getDate()) + '"]').addClass('picker-calendar-day-selected');
            }
...
/*                if (day.hasClass('picker-calendar-day-next')) p.nextMonth();
                ...
                var dateMonth = day.attr('data-month')-1;
        ...
        p.monthHTML = function (date, offset) {
            ...
            for (i = 1; i <= rows; i++) {
                ...
                for (j = 1; j <= cols; j++) {
                    ...
                    rowHTML += '<div data-year="' + dayYear + '" data-month="' + dayMonth + '" data-day="' + dayNumber + '" class="picker-calendar-day' + (addClass) + '" data-date="' + (dayYear + '-' + formatNumber(dayMonth) + '-' + formatNumber(dayNumber)) + '"><span>'+dayNumber+'</span></div>';
                }
        ...
        p.updateCurrentMonthYear = function (dir) {
            ...
            p.container.find('.current-month-value').attr('data-month',p.currentMonth+1);
...
+ function($) {
    ...
    var initMonthes = function(){return ('01 02 03 04 05 06 07 08 09 10 11 12').split(' ')};

    var initYears = function (min,max) {

        var arr = [];
        for (var i = (min ? min : 1950); i <= (max ? max : 2030); i++) { arr.push(i); }
        return arr;
    };
    ...
    var setLimitDate = function(p){
        var minDate = p.minDate ? new Date(p.minDate) : null;
        var maxDate = p.maxDate ? new Date(p.maxDate) : null;
        //set year
        p.cols[0].values = initYears(minDate ? minDate.getFullYear() : null, maxDate ? maxDate.getFullYear() : null);
        p.cols[6].values = ['00','15','30','45'];
    };
...
+function ($) {
    ...
    Router.prototype.parseXHR = function(xhr) {
        //if(xhr.responseURL.indexOf('xlsx') != -1)return;
    ...
    $(function() {
        ...
        $(document).on("click", "a", function(e) {
            ...
            if(!url || url === "#") return;
            /*(url.indexOf('xlsx') == -1) && */router.loadPage(url);
        })
    });
}(Zepto);
// jshint ignore: end
